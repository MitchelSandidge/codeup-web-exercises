console.log("Hello from practice-objects.js");
...
// console.log(aphorisms[1].quote);
// console.log(aphorisms[2].quote);
// console.log(aphorisms[3].quote);
// console.log(aphorisms[4].quote);
...
function formatQuote(input) {
    return "'" +aphorisms[input].quote + "'" + " -" + aphorisms[input].author
}
console.log(formatQuote(6));
