...
var favoriteFoods = ['chicken breast', 'peanut butter and jelly', 'spaghetti', 'salmon'];
...
//     console.log("My favorite food at index " + i + " is " + favoriteFoods[i]);
// }

// TODO: Refactoring the instructor loop, alert "hey, I know <INSTRUCTOR NAME HERE>" if you have had class with that instructor. If you have not had class with that instructor, alert "I haven't had class with <INSTRUCTOR NAME HERE> yet!"
// for (var i = 0; i < instructors.length; i++ ){
//     console.log("Instructor at index " + i + " is " + instructors[i])
//     if (instructors[i] === "david") {
//         alert("Hey i know him!");
//     } else if (instructors[i] === "vivian") {
//         alert("i know Vivian!")
//     } else if (instructors[i] === "trant") {
//         alert("i dont know trant but he seems like a cool dude, and i like his name")
//     } else {
//         alert("i dont know this person");
//     }
// }
...
// instructors.forEach(function (sillyguys) {
//     console.log(sillyguys);
// });
...
// favoriteFoods.forEach(function (meal) {
//     console.log(meal);
// });
